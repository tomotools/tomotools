...
class NFF:
    ...
    def __init__(
        self, path, red, green, blue, Kd, Ks, Shine, T, index_of_refraction, contours
    ):
        self.path = path
        self.red = red
        self.green = green
    ...
    def read(path) -> "NFF":
        ...
        with open(path) as file:
            ...
            for line in file:
                ...
                if points_to_parse > 0:
                    ...
                    if len(split) != 9:
                        raise SyntaxError(
                            "Format field has unexpected amount of values"
                        )
                    ...
                    if len(split) != 2:
                        raise SyntaxError(
                            "Points field has unexpected amount of values"
                        )
        ...
        return NFF(
            path, red, green, blue, Kd, Ks, Shine, T, index_of_refraction, contours
        )
