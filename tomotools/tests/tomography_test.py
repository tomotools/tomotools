...
class Testing(unittest.TestCase):
    def test_reconstruct(self):
        ...
        params = {'move': False, 'local': False, 'extra_thickness': 0, 'bin': 1, 'sirt': 8, 'keep_ali_stack': 1, 
                  'previous': None, 'batch_file': None}
        
        testfiles = ['testfiles/UniHD_K3_2206.mrc','testfiles/UZH_K2_2111.mrc','testfiles/UZH_K2_2207.mrc','testfiles/UZH_K3_2207.mrc']                
        ...
        for testfile in testfiles:
            with self.subTest(testfiles):
                ...
                self.assertNotIn(reconstruction, )
